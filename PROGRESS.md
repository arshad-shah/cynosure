...
> **Next action:** Read `08-forms-advanced.md` and ship the advanced form surface (Select/Combobox/DatePicker/Slider/FileUpload) on top of the Phase 07 `FormControlBase` contract and visual recipe. Prefer React Aria for complex keyboard interactions; keep the Radix / React-Aria split documented in the Phase 07 decision.
