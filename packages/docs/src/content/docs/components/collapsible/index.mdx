...
bundleSize: "—"
tags: [data-display, disclosure, radix]
---
...
<div><StatusBadge status="stable" /> <BundleSizePill name="Collapsible" /></div>
...
<Collapsible>
  ...
  <CollapsibleContent>Hidden details go here.</CollapsibleContent>
</Collapsible>
```
