...
description: A notification bell that opens a popover with tabbed categories, a notification list, and toast integration for new arrivals.
order: 6
category: recipes
---

{/* migrated from /docs/recipes/notification-center.mdx */}
