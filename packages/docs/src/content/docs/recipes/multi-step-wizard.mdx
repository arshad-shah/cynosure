...
description: A Stepper-driven multi-step form where state lives in a single reducer so step transitions preserve inputs.
order: 5
category: recipes
---

{/* migrated from /docs/recipes/multi-step-wizard.mdx */}
