---
title: Custom Themes
description: How to author a custom Cynosure theme by overriding semantic CSS tokens for a data-theme selector.
order: 5
...
A Cynosure theme is a CSS file that overrides the semantic tokens for a
...
Cynosure ships a contrast audit script that walks compiled CSS and asserts
...
All Cynosure components read CSS custom properties through normal cascade, so
scoping "just works".
