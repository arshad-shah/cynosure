...
- [Installation](/docs/getting-started/installation) — add Cynosure to your project in minutes.
- [Quickstart](/docs/getting-started/quickstart) — render your first components.
- [Theming overview](/docs/foundations/theming-overview) — learn how themes work.
